...
#安装包下载地址
INSTALLPACK=https://github.com/GitH123i/serverspeeder/blob/test/91yunserverspeeder.tar.gz?raw=true
#判断版本支持情况的地址
CHECKSYSTEM=https://raw.githubusercontent.com/GitH123i/serverspeeder/test/serverspeederbin.txt
#bin下载地址
